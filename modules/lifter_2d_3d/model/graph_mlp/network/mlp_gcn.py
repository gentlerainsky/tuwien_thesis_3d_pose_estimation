...
class Block(nn.Module):
    # self, length, frames, embed_dim, tokens_dim, channels_dim, adj, drop=drop_rate, drop_path=dpr[i], norm_layer=norm_layer
...
class Mlp_gcn(nn.Module):
    # Mlp_gcn(layers, channel, d_hid, token_dim, self.A, length=n_joints, frames=frames)
